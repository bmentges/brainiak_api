...
class CollectionResourceTestCase(TornadoAsyncHTTPTestCase, QueryTestCase):
    ...
    @patch("brainiak.instance.create_resource.create_instance_uri", return_value="http://example.onto/City/123")
    @patch("brainiak.instance.get_resource.settings", DEFAULT_RULESET_URI="{0}ruleset".format(graph_uri))
    @patch("brainiak.instance.get_resource.triplestore")

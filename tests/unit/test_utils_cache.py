...
class MemoizeDecoratorTestCase(unittest.TestCase):
    ...
    @patch("brainiak.utils.cache.redis_server.set")
    @patch("brainiak.utils.cache.redis_server.get")
    ...
    @patch("brainiak.utils.cache.redis_server.set", return_value=True)
    @patch("brainiak.utils.cache.redis_server.get", return_value=None)
    @patch("brainiak.utils.cache.redis", StrictRedisMock=StrictRedisMock)
    ...
    @patch("brainiak.utils.cache.settings", ENABLE_CACHE=True)
    @patch("brainiak.utils.cache.redis_server.set", return_value=True)
    @patch("brainiak.utils.cache.redis_server.get", return_value='{"status": "Dishes cleaned up"}')
    @patch("brainiak.utils.cache.redis", StrictRedisMock=StrictRedisMock)
